...
from src.animals.display import update_animal_support_point
        ...
        for _ in range( num_animals ):
            ...
            while True:
                ...
                if id_animal.lower() == 'sair':
                    return
                verify_animal= update_animal_support_point(id_animal, name)
    ...
    if id_delete in support_points and support_points[id_delete]['name'] == confirm_name:
        ...
        if confirm.lower() == 's':
            ...
            for id_animal in support_points[id_delete]["animals"].keys():
                update_animal_support_point(id_animal,"")
